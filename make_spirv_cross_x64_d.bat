...
@echo on
REM clone git repo
git clone https://github.com/KhronosGroup/SPIRV-Cross.git spriv_cross_tmp_x64_d
@echo off
REM path of source
@set SOURCE_DIR=%TOP%spriv_cross_tmp_x64_d\
...
REM copy
@move /y "%SOURCE_DIR%Debug\*.lib" "%TOP%dependencies\x64\lib_d"
