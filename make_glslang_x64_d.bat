...
@echo on
REM clone git repo
git clone https://github.com/KhronosGroup/glslang.git glslang_tmp_x64_d
@echo off
REM path of source
@set SOURCE_DIR=%TOP%glslang_tmp_x64_d\
...
@cd %SOURCE_DIR%
@echo on
cmake -G "Visual Studio 15 2017 Win64" -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX="%INSTALL_DIR%" %SOURCE_DIR%
...
REM copy
@move /y "%SOURCE_DIR%glslang\Debug\*.lib" "%TOP%dependencies\x64\lib\"
@move /y "%SOURCE_DIR%glslang\OSDependent\Windows\Debug\*.lib" "%TOP%dependencies\x64\lib\"

@move /y "%SOURCE_DIR%SPIRV\Debug\*.lib" "%TOP%dependencies\x64\lib_d\"
@move /y "%SOURCE_DIR%hlsl\Debug\*.lib" "%TOP%dependencies\x64\lib_d\"
@move /y "%SOURCE_DIR%OGLCompilersDLL\Debug\*.lib" "%TOP%dependencies\x64\lib_d\"
@move /y "%SOURCE_DIR%StandAlone\Debug\*.lib" "%TOP%dependencies\x64\lib_d\"
REM delete
@del /s /q  "%SOURCE_DIR%*"
